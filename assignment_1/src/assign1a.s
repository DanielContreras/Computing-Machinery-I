...
main:   
        ...
        mov     x20, -50000000000                                               // Initialize y 
        mov     x21, -50000000000                                               // Initialize currentMaximum
...
test:
        ...
        b.gt    end                                                             // If x is greater than 5, jump to label end
top:
...
print:
        ...
        mov     x2, 20                                                          // set y to x2 parameter
        mov     x3, 21                                                          // set currentMaximum to x3 parameter
